...
install: inc/nin.c enhance/nhan.c leet/nleet.c com/ncom.c clean/nclean.c rev/nrev.sh wiz/nwiz.sh inc/ninc.1 enhance/nhance.1 rev/nrev.1 leet/nleet.1 com/ncom.1
	$(CC) enhance/nhan.c -o nhance
	$(CC) inc/nin.c -o ninc
	$(CC) leet/nleet.c -o nleet
	$(CC) com/ncom.c -o ncom
...
uninstall: /bin/ninc /bin/nhance /bin/nrev /bin/nleet /bin/ncom /bin/nclean /bin/nwiz $(MD)ninc.1 $(MD)nhance.1 $(MD)nrev.1 $(MD)nleet.1 $(MD)ncom.1
